...
<head>
    ...
    <script>
        $(document).ready(function() {
            $('#applyForLoanListTable').DataTable();
        } );
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9" style="background-color: #d7d7d7;padding-bottom:20px;">
            <h3 style="color:#0f8200;">My Approved Loan List</h3>
            <hr/>



            <c:if test="${!empty applyForLoanList}">
                <table id="applyForLoanListTable" class="table table-bordered" style="width: 103.5%;margin-left:-15px;">
                    <thead>
                    <tr>
                        <th style="color:#ffffff;background-color:#0f8200;">Loan Id</th>
                        <th style="color:#ffffff;background-color:#0f8200;">Email Id</th>
                        <th style="color:#ffffff;background-color:#0f8200;">Loaning Amount</th>
                        <th style="color:#ffffff;background-color:#0f8200;">Loan Status</th>
                        <th style="color:#ffffff;background-color:#0f8200;">Get Investers</th>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${applyForLoanList}" var="applyForLoan">
                        <tr>
                            ...
                            <td><a href="${pageContext.request.contextPath}/user/getInvesters/${applyForLoan.loanId}">Investers</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
            ...
            <c:if test="${!empty fixedInvesterList}">
                <hr/>
                <h3 style="color:#0f8200;">My Investers List</h3>

                <hr/>
                <table id="investerListTable" class="table table-bordered" style="width: 103.5%;margin-left:-15px;">
                    <thead>
                    <tr>
                        <th style="color:#ffffff;background-color:#0f8200;">Intrest Rate</th>
                        <th style="color:#ffffff;background-color:#0f8200;">Investing Amount</th>
                        <th style="color:#ffffff;background-color:#0f8200;">Invester Contact</th>
                        <th style="color:#ffffff;background-color:#0f8200;">Invester Email</th>
                        <th style="color:#ffffff;background-color:#0f8200;">Invester Id</th>
                        <th style="color:#ffffff;background-color:#0f8200;">Invester Name </th>
                        <th style="color:#ffffff;background-color:#0f8200;">Monthly Record</th>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${fixedInvesterList}" var="fixedInvester">
                        <tr>
                            <td>${fixedInvester.intrestRate}</td>
                            <td>${fixedInvester.investingAmount}</td>
                            <td>${fixedInvester.investerContact}</td>
                            <td>${fixedInvester.investerEmail}</td>
                            <td>${fixedInvester.investerId}</td>
                            <td>${fixedInvester.investerName}</td>
                            <td><a href="${pageContext.request.contextPath}/user/getMonthlyDetail/${fixedInvester.investerId}/${fixedInvester.loanId}" class="btn btn-danger">Get</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
