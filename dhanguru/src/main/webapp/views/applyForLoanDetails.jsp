...
<div class="container-fluid">
    <div class="row">
                        ...
                        <fieldset>
                            <div style="border:1px solid #989898;position: relative;left:0%;padding:0em;width:100%;float:left;margin-left:5px;">
                                ...
                                <table cellspacing="4" cellpadding="0" width="100%" style="margin-top:20px;margin-left:15%;">
                                    ...
                                    <tr>
                                        <td style="padding-top:3px;padding-bottom:3px;">
                                            <a href="${pageContext.request.contextPath}/user/applyForLoanList">
        ...
        <div class="col-sm-9" style="background-color:#d7d7d7;padding:0 0 20px 0;">
            <h3 style="color:#0f8200;">Apply For Loan Details</h3>
            <hr/>

            <div class="row" style="padding-bottom: 10px;">
                <div class="col-sm-4" style="text-align:center;">
                    <label style="font-size:12px;">Contact Details:</label>
                    <div>
                        ${applyForLoan.contactDetailsProof}
                    </div>
                </div>
                <div class="col-sm-4" style="text-align:center;">
                    <label style="font-size:12px;">Amount For Loan:</label>
                    <div>
                        ${applyForLoan.loaningAmount}
                    </div>
                </div>
                <div class="col-sm-4" style="text-align:center;">
                    <label style="font-size:12px;">ID Proof:</label>
                    <div>
                        <a href="#" onclick="OpenNewWindow('${pageContext.request.contextPath}/user/downloadIDProof/${applyForLoan.id}', 500, 500); return true;">
                            <img src="${pageContext.request.contextPath}/user/downloadIDProof/${applyForLoan.id}" height="150" width="150"/>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="padding: 10px 0 10px 0;">
                <div class="col-sm-4" style="text-align:center;">
                    <label style="font-size:12px;">Age Proof:</label>
                    <div>
                        <a href="#" onclick="OpenNewWindow('${pageContext.request.contextPath}/user/downloadAgeProof/${applyForLoan.id}', 500, 500); return true;">
                            <img src="${pageContext.request.contextPath}/user/downloadAgeProof/${applyForLoan.id}" height="150" width="150"/>
                        </a>
                        <%--<input type="file" class="form-control" name="fileUpload" value="${applyForLoan.ageProof}" placeholder="Enter Age Proof" readonly>--%>
                    </div>
                </div>
                <div class="col-sm-4" style="text-align:center;">
                    <label style="font-size:12px;">Address Proof:</label>
                    <div>
                        <a href="#" onclick="OpenNewWindow('${pageContext.request.contextPath}/user/downloadAddressProof/${applyForLoan.id}', 500, 500); return true;">
                            <img src="${pageContext.request.contextPath}/user/downloadAddressProof/${applyForLoan.id}" height="150" width="150"/>
                        </a>
                    </div>
                </div>
                <div class="col-sm-4" style="text-align:center;">
                    <label style="font-size:12px;">Employment Proof:</label>
                    <div>
                        <a href="#" onclick="OpenNewWindow('${pageContext.request.contextPath}/user/downloadEmploymentProof/${applyForLoan.id}', 500, 500); return true;">
                            <img src="${pageContext.request.contextPath}/user/downloadEmploymentProof/${applyForLoan.id}" height="150" width="150"/>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="padding: 10px 0 10px 0;">
                <div class="col-sm-4" style="text-align:center;">
                    <label style="font-size:12px;">Income Proof:</label>
                    <div>
                        <a href="#" onclick="OpenNewWindow('${pageContext.request.contextPath}/user/downloadIncomeProof/${applyForLoan.id}', 500, 500); return true;">
                            <img src="${pageContext.request.contextPath}/user/downloadIncomeProof/${applyForLoan.id}" height="150" width="150"/>
                        </a>
                    </div>
                </div>
                <div class="col-sm-4" style="text-align:center;">
                    <label style="font-size:12px;">Bank Statement:</label>
                    <div>
                        <a href="#" onclick="OpenNewWindow('${pageContext.request.contextPath}/user/downloadBankStatement/${applyForLoan.id}', 500, 500); return true;">
                            <img src="${pageContext.request.contextPath}/user/downloadBankStatement/${applyForLoan.id}" height="150" width="150"/>
                        </a>
                    </div>
                </div>
                <div class="col-sm-4" style="text-align:center;">
                    <label style="font-size:12px;">Signature Proof::</label>
                    <div>
                        <a href="#" onclick="OpenNewWindow('${pageContext.request.contextPath}/user/downloadSignatureProof/${applyForLoan.id}', 500, 500); return true;">
                            <img src="${pageContext.request.contextPath}/user/downloadSignatureProof/${applyForLoan.id}" height="150" width="150"/>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="padding: 10px 0 10px 0;">
                <div class="col-sm-4" style="text-align:center;">
                    <label style="font-size:12px;">Photograph:</label>
                    <div>
                        <a href="#" onclick="OpenNewWindow('${pageContext.request.contextPath}/user/downloadPhotograph/${applyForLoan.id}', 500, 500); return true;">
                            <img src="${pageContext.request.contextPath}/user/downloadPhotograph/${applyForLoan.id}" height="150" width="150"/>
                        </a>
                    </div>
                </div>
