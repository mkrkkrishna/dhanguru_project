...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9" style="width:74%;background-color:#d7d7d7;padding-bottom: 20px;">
            <h3 style="color:#0f8200;">Apply For Loan</h3>
            <hr/>

            <div style="width:100%;margin-top:50px;">
                <h2 style="color:red;">${notMatch}</h2>
                <a href="${pageContext.request.contextPath}/user/applyForLoanList" class="btn btn-success">Continue</a>
            </div>
        </div>
    </div>
</div>
