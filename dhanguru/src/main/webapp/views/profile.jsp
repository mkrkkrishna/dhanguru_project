                ...
                <ul class="nav navbar-nav m-menu">
                    <li class="page_item page-item-8 page_item_has_children">
                        ...
                        <ul class="children">
                            ...
                            <li class="page_item page-item-98"><a style="color:#0f8200;" href="${pageContext.request.contextPath}/mgt">Board of Management</a></li>
			...
			<div class="row">
				<div class="col-sm-3">
					<p style="margin-left:20%;margin-top:30px;font-size:15px;">
						...
						<p style="text-align:center;text-transform: uppercase;font-size:18px;">${usersProfile.fullName}</p>
					</p>

					<p style="margin-left:5%;margin-top:10px;">
						<span style="font-size:25px;" class="glyphicon glyphicon-user"></span>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="${pageContext.request.contextPath}/user/myPersonalData" class="btn btn-success" style="width:70%;">MY PROFILE</a>
					</p>
					...
					<table class="table" cellpadding="0" cellspacing="0"><!-- margin-left:-20px;width:124.5%; -->
    					<tr>
        					<td>
			            		<fieldset>
    	    		        		<div style="border:1px solid #989898;position: relative;left:0%;padding:0em;width:100%;float:left;margin-left:5px;">
        			    		        ...
        			    		        <table cellspacing="4" cellpadding="0" width="100%" style="margin-top:20px;margin-left:15%;">
                                            ...
                                            <tr>
                                                <td style="padding-top:3px;padding-bottom:3px;">
                                                    <a href="${pageContext.request.contextPath}/user/inversterList">
                                                        Lending List
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="padding-top:3px;padding-bottom:3px;">
                                                    <a href="/user/wantMoneyList" style="font-color:#FFFFFF;">
                                                        Borrowers List
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="padding-top:3px;padding-bottom:3px;">
                                                    <a href="${pageContext.request.contextPath}/user/applyForLoanList" style="font-color:#FFFFFF;">
                                            ...
                                            <tr>
                                                <td style="padding-top:3px;padding-bottom:3px;">
                                                    <a href="${pageContext.request.contextPath}/user/profile" style="font-color:#FFFFFF;">
                                                        Apply for Loan
                                                    </a>
                                                </td>
                                            </tr>
				...
				<div class="col-sm-9" style="background-color:#d7d7d7;padding-bottom: 20px;">
					<h3 style="color:#0f8200;">Apply For Loan</h3>
					<hr/>

                    <div style="width:100%;margin-top:50px;">
                        <form action="${pageContext.request.contextPath}/user/saveApplyLoan"  method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Contact Details:</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="contactProof" placeholder="Enter Contact Details" required>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;font-size:13px;">Amount For Loan:</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="loaningAmount" placeholder="Enter Loaning Amount" required>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">ID Proof:</label>
                                <div class="col-md-5">
                                    <input type="file" class="form-control" name="fileUpload" placeholder="Enter ID Proof" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Age Proof:</label>
                                <div class="col-md-5">
                                    <input type="file" class="form-control" name="fileUpload" placeholder="Enter Age Proof" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Address Proof:</label>
                                <div class="col-md-5">
                                    <input type="file" class="form-control" name="fileUpload" placeholder="Enter Address Proof" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" style="font-size:12px;padding-left:30px;">Employment Proof:</label>
                                <div class="col-md-5">
                                    <input type="file" class="form-control" name="fileUpload" placeholder="Enter Employment Proof" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Income Proof:</label>
                                <div class="col-md-5">
                                    <input type="file" class="form-control" name="fileUpload" placeholder="Enter Income Proof" required>
                                </div>
                            </div>


                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Bank Statement:</label>
                                <div class="col-md-5">
                                    <input type="file" class="form-control" name="fileUpload" placeholder="Enter Bank Statement" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Signature Proof:</label>
                                <div class="col-md-5">
                                    <input type="file" class="form-control" name="fileUpload" placeholder="Enter Signature Proof" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Photograph:</label>
                                <div class="col-md-5">
                                    <input type="file" class="form-control" name="fileUpload" placeholder="Enter Photograph" required>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <c:if test="${!empty applyForLoanList}">
                        <table id="loanApplyTable" style="margin-top:50px;margin-left:-15px;width:103.5%;" class="table table-bordered">
                            <thead>
                            <tr style="border:1px solid black;">
                                <th style="color:#ffffff;background-color:#0f8200;">Loan Id</th>
                                <th style="color:#ffffff;background-color:#0f8200;">Email ID</th>
                                <th style="color:#ffffff;background-color:#0f8200;">Contact Number</th>
                                <th style="color:#ffffff;background-color:#0f8200;">Amount</th>
                                <th style="color:#ffffff;background-color:#0f8200;">Status</th>
                                <th style="color:#ffffff;background-color:#0f8200;">More Details</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${applyForLoanList}" var="applyForLoan">
                                <tr style="border:1px solid black;">
                                    <td>${applyForLoan.loanId}</td>
                                    <td>${applyForLoan.emailId}</td>
                                    <td>${applyForLoan.contactDetailsProof}</td>
                                    <td>${applyForLoan.loaningAmount}</td>
                                    <td>${applyForLoan.loanStatus}</td>
                                    <td><a href="${pageContext.request.contextPath}/user/showApplyForLoanDetails/${applyForLoan.id}">More Details</a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
