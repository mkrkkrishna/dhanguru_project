	...
	<head>
        ...
        <script>
            $(document).ready(function() {
                $('#serviceCityListTable').DataTable();
            } );
			...
			<div class="row">
				<div class="col-sm-3">
					<p style="margin-left:20%;margin-top:30px;font-size:15px;">
						...
						<p style="text-align:center;text-transform: uppercase;font-size:18px;"><span style="font-size:25px;" class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;&nbsp;&nbsp;ADMIN</p>
					</p>
				...
				<div class="col-sm-9" style="background-color: #d7d7d7;padding-bottom: 20px;">
					<h3 style="color:#0f8200;">Add Service City</h3>
					<hr/>
                    <div style="width:100%;margin-top:50px;">
                        <form action="${pageContext.request.contextPath}/admin/saveServiceCity"  method="post" class="form-horizontal" role="form" >
                            <div class="form-group">
                                <label class="control-label col-sm-2">Service City:</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="serviceCity" placeholder="Enter Service City" required>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <hr/>
                    <c:if test="${!empty serviceCityList}">
                        <table id="serviceCityListTable" class="table table-bordered" style="margin-left:-15px;width:103.5%;">
                            <thead>
                            <tr>
                                <th style="background-color: #0f8200;color: #ffffff;">Service City</th>
                                <th style="background-color: #0f8200;color: #ffffff;">Pincode</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${serviceCityList}" var="serviceCity">
                                <tr>
                                    <td>${serviceCity.serviceCity}</td>
                                    <td>${serviceCity.pincode}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
