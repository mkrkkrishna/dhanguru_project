			...
			<div class="row">
				...
				<div class="col-sm-9" style="background-color: #d7d7d7;padding-bottom:20px;">
                    ...
                    <c:if test="${!empty feedbackList}">
                        <table id="feedbackListTable" class="table" style="margin-left:-15px;width:103.5%;">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <c:forEach items="${feedbackList}" var="feedback">
                                    <tr>
                                        <td><a href="${pageContext.request.contextPath}/showFeedbackDetails/${feedback.id}"><h6>${feedback.name}</h6></a></td>
                                        <td><a href="${pageContext.request.contextPath}/showFeedbackDetails/${feedback.id}"><h6>${feedback.subjectFeedback}</h6></a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
