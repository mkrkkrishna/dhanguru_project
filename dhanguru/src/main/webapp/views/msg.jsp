                ...
                <div class="col-sm-3">
                    <ul class="list-group">
                        <li class="list-group-item">
                            <button id="model" class="btn btn-success btn-block" style="text-shadow: -2px -1px #000000;font-size:130%;"><span class="glyphicon glyphicon-plus-sign"></span>&nbsp;&nbsp;New Message</button>
                        </li>
                        <li class="list-group-item"><a href="#" style="color:#000000;">Inbox</a></li>
                        <li class="list-group-item"><a href="#" style="color:#000000;">Draft</a></li>
                        <li class="list-group-item"><a href="#" style="color:#000000;">Sent</a></li>
                    </ul>
                </div>
