...
<html>
<head>
    <title>Contact Us Detail - Dhanguru</title>
    <!-- contactUsDetail.jsp -->
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9" style="background-color: #d7d7d7;">
            <h4 style="color:#0f8200;"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;&nbsp;${contactUs.name}</h4>
            <hr/>
            <p><span class="glyphicon glyphicon-envelope"></span>&nbsp;&nbsp;&nbsp;<b>${contactUs.emailId}</b></p>
            <p><span class="glyphicon glyphicon-earphone"></span>&nbsp;&nbsp;&nbsp;<b>${contactUs.mobileNumber}</b></p>
            <p><b>Subject:- </b>${contactUs.subjectEnquiry}</p>
            <hr/>
            <pre>${contactUs.query}</pre>
            <br>
            <hr>
            <form action="${pageContext.request.contextPath}/replyContactUs/${contactUs.emailId}/${contactUs.subjectEnquiry}" method="post">
                <div class="form-group" style="padding-top: 5px;">
                    <textarea class="form-control" name="replyText" rows="2" placeholder="REPLY TEXT" required></textarea>
                </div>
                <div class="form-group" style="padding-top: 10px; padding-right: 10px;">
                    <input name="submit" type="submit" value="Reply" class="btn btn-info" style="color:#FFFFFF;">
                </div>
            </form>
        </div>
