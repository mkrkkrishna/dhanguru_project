	...
	<style>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-9" style="padding-bottom:20px;background-color: #d7d7d7;">
					<p><h3 style="color:#0f8200;">Who Applied for Loan</h3><h5 style="margin-right:10px;margin-top:-30px;float: right;">Customer Care Helpline</h5></p>
					<hr/>
                    <c:if test="${!empty applyForLoanList}">
                        <table id="applyForLoanListTable" class="table table-bordered" style="margin-left:-15px;width: 103.5%;">
                            <thead>
                                <tr>
                                    <th style="color:#ffffff;background-color:#0f8200;">Loan Id</th>
                                    <th style="color:#ffffff;background-color:#0f8200;">Email</th>
                                    <th style="color:#ffffff;background-color:#0f8200;">Contact</th>
                                    <th style="color:#ffffff;background-color:#0f8200;font-size:12px;">Loaning Amount</th>
                                    <th style="color:#ffffff;background-color:#0f8200;font-size:12px;">More Details</th>
                                    <th style="color:#ffffff;background-color:#0f8200;font-size:12px;width: 10%;">Investing Amount</th>
                                    <th style="color:#ffffff;background-color:#0f8200;">Invest</th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${applyForLoanList}" var="applyForLoan">
                                    <tr>
                                        ...
                                        <td><a href="${pageContext.request.contextPath}/user/securityKey/${applyForLoan.id}">More Details</a></td><%--${pageContext.request.contextPath}/user/showApplyForLoanDetails/${applyForLoan.id}--%>

                                        <form action="${pageContext.request.contextPath}/user/saveIntrestInInvest" method="post">
                                            <td>
                                                <input type="text" name="investingAmount" style="width:100%;" required/>
                                            </td>
                                            <td>
                                                <input type="hidden" name="loanId" value="${applyForLoan.loanId}"/>
