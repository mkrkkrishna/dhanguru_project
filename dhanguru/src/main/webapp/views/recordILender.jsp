    ...
    <div class="row">
        ...
        <div class="col-sm-9" style="background-color:#d7d7d7;padding-bottom: 20px;">
            ...
            <div class="container" style="width: 95%;">
                <div class="col-ms-3">
                    <img src="${pageContext.request.contextPath}/user/downloadPhotograph/${applyForLoan.id}" height="200" width="200"/>
                </div>
                <div class="col-ms-9">
                    <div class="row">
                        <div class="col-sm-6">
                            <p>Name:- <span style="font-size:17px;">${usersProfile.fullName}</span></p>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <p>Approved Date:- <span style="font-size:17px;">${applyForLoan.approveDate}</span></p>
                        </div>
                        <div class="col-sm-6">
