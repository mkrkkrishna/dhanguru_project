                        ...
                        <fieldset>
                            <div style="border:1px solid #989898;position: relative;left:0%;padding:0em;width:100%;float:left;margin-left:5px;">
                                ...
                                <table cellspacing="4" cellpadding="0" width="100%" style="margin-top:20px;margin-left:15%;">
                                    ...
                                    <tr>
                                        <td style="padding-top:3px;padding-bottom:3px;">
                                            <a href="${pageContext.request.contextPath}/user/wantMoneyList/${usersProfile.id}" style="font-color:#FFFFFF;">
                                                Borrowers List
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="padding-top:3px;padding-bottom:3px;">
                                            <a href="${pageContext.request.contextPath}/user/applyLoan/${usesProfile.id}" style="font-color:#FFFFFF;">
                                                Apply for Loan
                                            </a>
                                        </td>
                                    </tr>
