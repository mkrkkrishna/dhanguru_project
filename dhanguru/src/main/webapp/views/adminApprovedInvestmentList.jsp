...
<html>
	<head>
		...
		<!-- adminApprovedInvestmentList.jsp -->
        ...
        <script>
            $(document).ready(function() {
                $('#approvedInvestmentListTable').DataTable();
            } );
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-3">
					...
					<table class="table" cellpadding="0" cellspacing="0">
    					<tr>
        					<td>
			            		<fieldset>
                                    <div style="border:1px solid #989898;position: relative;left:0%;padding:0;width:100%;float:left;margin-left:5px;">
				...
				<div class="col-sm-9" style="background-color: #d7d7d7;padding-bottom: 20px;">
					<h4 style="color:#0f8200;">View Approved Imvestment List</h4>
					<hr/>
                    <c:if test="${!empty approvedInvestmentList}">
                        <table id="approvedInvestmentListTable" class="table table-bordered" style="width:103.5%;margin-left: -15px;">
                            <thead>
                                <tr>
                                    <th style="background-color: #0f8200;color:#FFFFFF;font-size: 12px;">Invester Email</th>
                                    <th style="background-color: #0f8200;color:#FFFFFF;font-size: 12px;">Want Money Email</th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${approvedInvestmentList}" var="approvedInvestment">
                                    <tr>
                                        <td><h6>${approvedInvestment.investerEmail}</h6></td>
                                        <td><h6>${approvedInvestment.wantMoneyEmail}</h6></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
    	        ...
    	        <div class="row">
        			...
        			<div class="col-md-3">   	        		
                    	...
                    	<div style="text-align:center;box-shadow: 0px 0px 15px white;height:300px;width:100%;">
                    		<ul style="padding-left:0px;padding-top:0px;margin-left:0px;list-style-type: none;">
