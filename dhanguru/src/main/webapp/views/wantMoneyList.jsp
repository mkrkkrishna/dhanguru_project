...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9" style="background-color: #d7d7d7;padding-bottom:20px;">
            <h3 style="color:#0f8200;">Borrower List</h3>
            <hr/>
            <c:if test="${!empty fixedInvesterList}">
                <table id="fixedInvesterListTable" class="table table-bordered" style="margin-left:-15px;width: 103.5%;">
                    <thead>
                    <tr>
                    ...
                    <c:forEach items="${fixedInvesterList}" var="fixedInvester">
                        <tr>
                            <td><a href="${pageContext.request.contextPath}/user/getBorrowerDetails/${fixedInvester.loanId}">${fixedInvester.loanId}</a></td>
                            <td>${fixedInvester.investerId}</td>
                            <td>${fixedInvester.intrestRate}</td>
                            <td><a href="${pageContext.request.contextPath}/user/getMonthlyRecored/${fixedInvester.investerId}/${fixedInvester.loanId}">${fixedInvester.investingAmount}</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
