...
<h5>${pageContext.request.userPrincipal}</h5>

<h5>${usersProfile.fullName}</h5>
	
<h5>${usersProfile.fatherName}</h5>
	
<h5>${usersProfile.motherName}</h5>

<h5>${usersProfile.sex}</h5>
	
 <h5>${usersProfile.dob}</h5>
	
 <h5>${usersProfile.nationality}</h5>
	
 <h5>${usersProfile.streetAddress}</h5>
	
 <h5>${usersProfile.address}</h5>
	
 <h5>${usersProfile.city}</h5>
	
 <h5>${usersProfile.pincode}</h5>
	
 <h5>${usersProfile.state}</h5>
	
 <h5>${usersProfile.country}</h5>
	
 <h5>${usersProfile.emailId}</h5>
 
  <h5>${usersProfile.enabled}</h5>
