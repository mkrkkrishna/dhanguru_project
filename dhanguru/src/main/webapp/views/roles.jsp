...
<header>
	...
	<div class="container">
		<section style="height:470px;box-shadow: 0px 0px 5px #006600;">
			<div id="roles" >
				<div style="background-color:#0f8200;padding:3px;">
					<h3 style="margin-left:15px;color:#FFFFFF;">Our Roles</h3>
				</div>
				<ul style="margin-top:2%;">
					<li>
						DHANGURU is just like a bridge between the lender and borrower for a loan transaction. DHANGURU ensures that the borrowers and lenders are verified through the information provided i.e. identities, employment details, income proofs, contact information(s) as well as creditworthiness (if any).
					</li>
					
					<li>
						DHANGURU also helps in the loan disbursement and monitoring process upon loan acceptance by a borrower i.e. ensures that required documentation has been done and proper agreements are executed by the borrowers and lenders, EMI cheques collected from borrower before loan disbursal and monitor the repayment.
					</li>
					
					<li>
						DHANGURU also sends regular alerts / notification to both lenders and borrowers on various activities in their account including status of registration, verification, loan offers received, loan accepted, disbursed, EMI due date alerts, EMI payment updates.
					</li>
				</ul>
			</div>
			<div id="fee" style="margin:30px;">
				<h2 style="color:#0f8200;">Fees &amp; Charges</h2>
				<p>	
					DHANGURU charges processing fee from borrowers (depends on the amount of loan), once the loan amount is disbursed and transaction fee from the lenders @1% of the loan amount in the first month only. Details of the various charges can be seen <a style="color:green;" href="">here</a>.
				</p> 
			</div>
		</section>
	</div>
