	...
	<div class="container">
		<section style="box-shadow: 0px 0px 5px #006600;">
			<div style="background-color:#0f8200;padding:3px;">
					<h3 style="margin-left:15px;color:#FFFFFF;">Management</h3>
				</div>
			<div id="faq_one" style="margin:30px;padding-bottom:20px;">
				
				<ol>
					<li>
                        <img class="img-rounded" src="/resources/images/rohit.jpg" width="50" height="50"/>
                        <h4 style="color:#0f8200">MANAV SHARMA</h4>
						<h5 style="color:#0f8200;">FOUNDER PARTNER - Head Legal & Operations </h5>
						<p>
							Manav Sharma, 32, is a law graduate and an Advocate by profession with work experience of 8 years. Manav is a young, dynamic and hard-working professional. He has vast and varied experience across all spectrums of Law. He started his career by working with a leading and reputed Delhi based Law Firm. Manav also has an accumulated experience in corporate laws and documentation during his stint with another reputed well known group named as Escorts Limited, an Auto Mobile Industry.
						</p>
					</li>
					<li>
                        <img class="img-rounded" src="/resources/images/rohit.jpg" width="50" height="50"/>
                        <h4 style="color:#0f8200;">ROHAN VERMA</h4>
                        <h5 style="color:#0f8200;">FOUNDER PARTNER- Head Finance & Financial Controller</h5>
						<p>
							Rohan Verma, 31, is a qualified professional in International Finance Management, from NCT New Delhi. Rohan Verma comes with wide ranging experience across diverse industries from Marketing to Accounting with proven track record of delivering year-on-year success for last 10 years. He has a vast experience in the Indian financial industry. Rohan Verma has more than 10 years of experience in the field of capital and money market. His area of interest, as well as experience has been that of ensuring financial inclusion.
						</p>
					</li>
                    <li style="margin-top:70px;">
                        <img class="img-rounded" src="/resources/images/rohit.jpg" width="50" height="50"/>
                        <h4 style="color:#0f8200">ROHIT KUMAR MISHRA</h4>
                        <h5 style="color:#0f8200;">FOUNDER PARTNER - Head Legal & Operations </h5>
                        <p>
                            Rohit Kumar Mishra, 32, is a law graduate and an Advocate by profession with work experience of 8 years. Manav is a young, dynamic and hard-working professional. He has vast and varied experience across all spectrums of Law. He started his career by working with a leading and reputed Delhi based Law Firm. Manav also has an accumulated experience in corporate laws and documentation during his stint with another reputed well known group named as Escorts Limited, an Auto Mobile Industry.
                        </p>
                    </li>
				</ol>
			</div>
