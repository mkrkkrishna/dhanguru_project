			            		...
			            		<fieldset>
                                    <div style="border:1px solid #989898;position: relative;left:0%;padding:0em;width:100%;float:left;margin-left:5px;">
        			    		        ...
        			    		        <table cellspacing="4" cellpadding="0" width="100%" style="margin-top:20px;margin-left:15%;">
                                            ...
                                            <tr>
                                                <td style="padding-top:3px;padding-bottom:3px;">
                                                    <a href="${pageContext.request.contextPath}/admin/applyForLoanList">
                                            ...
                                            <tr>
                                                <td style="padding-top:3px;padding-bottom:3px;">
                                                    <a href="${pageContext.request.contextPath}/admin/getSecurityKey" style="font-color:#FFFFFF;">
                                                        Security Key
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr >
                                                <td style="padding-top:3px;padding-bottom:3px;">
                                                    <a href="${pageContext.request.contextPath}/admin/addPayment" style="font-color:#FFFFFF;">
                                                        Add Payment
                                                    </a>
                                                </td>
                                            </tr>
                            ...
                            <tbody>
                                <c:forEach items="${fixedInvesterList}" var="fixedInvester">
                                    <tr>
                                        ...
                                        <td style="text-align:center;"><a href="${pageContext.request.contextPath}/admin/fixInvester/${intrestInInvest.id}" class="btn btn-info">ADD</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
