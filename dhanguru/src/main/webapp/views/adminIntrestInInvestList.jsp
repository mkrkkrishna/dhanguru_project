		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-9" style="background-color: #d7d7d7;padding-bottom: 20px;">
					<p><h4 style="color:#0f8200;">View Intrest In Investment List</h4></p>
					<hr/>
                    <div class="container" style="width: 95%;">
                        <div class="row">
                            <div class="col-sm-6">
                                <p><span style="font-size:11px;font-weight: bold;">Loan Id:- </span><span style="font-size:12px;">${applyForLoan.loanId}</span></p>
                            </div>
                            <div class="col-sm-6">
                                <p><span style="font-size:11px;font-weight: bold;">Email Id:- </span><span style="font-size:12px;">${applyForLoan.emailId}</span></p>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-6">
                                <p><span style="font-size:11px;font-weight: bold;">Contact Number:- </span><span style="font-size:12px;">${applyForLoan.contactDetailsProof}</span></p>
                            </div>
                            <div class="col-sm-6">
                                <p><span style="font-size:11px;font-weight: bold;">Loaning Amount:- </span><span style="font-size:12px;">${applyForLoan.loaningAmount}</span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <c:if test="${!empty intrestInInvestList}">
                        <table id="intrestInInvestListTable" class="table table-bordered" style="width: 103.5%;margin-left:-15px;">
                            <thead>
                                <tr>
                                    <th style="background-color: #0f8200;color:#ffffff;font-size:12px;">Loan Id</th>
                                    <th style="background-color: #0f8200;color:#ffffff;font-size:12px;">Invester Email</th>
                                    <th style="background-color: #0f8200;color:#ffffff;font-size:12px;">Investing Amount</th>
                                    <th style="background-color: #0f8200;color:#ffffff;font-size:12px;">Fix Invester</th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${intrestInInvestList}" var="intrestInInvest">
                                    <tr>
                                        <td><h6>${intrestInInvest.loanId}</h6></td>
                                        <td><a href="${pageContext.request.contextPath}/investerDetails/${intrestInInvest.id}"><h6>${intrestInInvest.investorEmail}</h6></a></td>
                                        <td><h6>${intrestInInvest.investingAmount}</h6></td>
                                        <td style="text-align:center;"><a href="${pageContext.request.contextPath}/admin/fixInvester/${intrestInInvest.id}" class="btn btn-info">Fix</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
