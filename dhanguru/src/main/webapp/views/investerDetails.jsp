...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9" style="background-color:#d7d7d7;">
            <h3 style="color:#0f8200;">Investers Details</h3>
            <hr/>
                ...
                <div class="container" style="width:100%;">
                    <div style="margin-top:0;">
                        <div class="row" style="margin-bottom:20px;margin-top:10px;">
                            ...
                            <div class="col-md-2" style="padding-left:60px;font-weight: bold;font-size: 10px;">Name:</div>
                            <div class="col-md-3"><span style="font-size:12px;">${usersProfile.fullName}</span></div>

                            <div class="col-md-2" style="padding-left:60px;font-weight: bold;font-size: 10px;">Mobile:</div>
                            <div class="col-md-3"><span style="font-size:12px;">${usersProfile.mobile}</span></div>
                        </div>

                        <div class="row" style="margin-bottom:20px;margin-top:10px;">

                            <div class="col-md-2" style="padding-left:60px;font-weight: bold;font-size: 10px;">Home Contact:</div>
                            <div class="col-md-3">${usersProfile.homeContact}</div>

                            <div class="col-md-2" style="padding-left:60px;font-weight: bold;font-size: 10px;">Office Contact:</div>
                            <div class="col-md-3"><span style="font-size:12px;">${usersProfile.officeContact}</span></div>
                        </div>


                        <div class="row" style="margin-bottom:20px;margin-top:20px;">
                            <div class="col-md-2" style="padding-left:60px;font-weight: bold;font-size: 10px;">Father Name:</div>
                            <div class="col-md-3"><span style="font-size:12px;">${usersProfile.fatherName}</span></div>

                            <div class="col-md-2" style="padding-left:60px;font-weight: bold;font-size: 10px;">Mother Name:</div>
                            <div class="col-md-3"><span style="font-size:12px;">${usersProfile.motherName}</span></div>
                        </div>

                        <div class="row" style="margin-bottom:20px;margin-top:20px;">

                            <div class="col-md-2" style="padding-left:60px;font-weight: bold;font-size: 10px;">Email ID:</div>
                            <div class="col-md-3"><span style="font-size:12px;">${usersProfile.emailId}</span></div>

                            <div class="col-md-2" style="padding-left:60px;font-weight: bold;font-size: 10px;"></div>
                            <div class="col-md-3"><span style="font-size:12px;"></span></div>
                        </div>
                    </div>
