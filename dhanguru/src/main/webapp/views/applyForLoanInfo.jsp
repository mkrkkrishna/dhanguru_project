        ...
        <div class="col-sm-9">
            ...
            <div style="width:100%;margin-top:50px;">
                <p style="font-size: 16px;">
                    Your Information for apply for loan is submitted & it is on underprocessing. Our Executive contact You Soon.
                    Click <a href="${pageContext.request.contextPath}/user/profile" style="color:#0f8200;">Here </a>For Continue
                </p>
            </div>
        </div>
    </div>
