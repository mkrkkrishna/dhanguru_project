...
<html>
	<head>
		<title>Forgot Password - Dhanguru</title>
		<!-- fPassword.jsp -->
	...
	<div class="container">
		<section style="box-shadow: 0px 0px 5px #006600;">
			<div style="background-color:#0f8200;padding:3px;">
				<h3 style="margin-left:15px;color:#FFFFFF;">Forgot Password</h3>
			</div>
			<div id="faq_one" style="margin:30px;padding-bottom:20px;">

                <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/getPassword" method="post">
   	 				<div class="form-group">
      					<label class="control-label col-sm-2" for="email">Registered Email:</label>
      					<div class="col-sm-5">
        					<input type="email" class="form-control" name="registerEmail" id="email" placeholder="ENTER REGISTER EMAIL" required>
      					</div>
    				</div>
    				<div class="form-group">        
                    ...
                    <c:if test="${not empty msg}">
                        <div class="msg" style="width:50%;color:red;">${msg}</div>
                    </c:if>
  				</form>
			</div>
<br><br><br>
