...
<html>
<head>
    <title>Feedback Detail - Dhanguru</title>
    <!-- feedbackDetail.jsp -->
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9" style="background-color: #d7d7d7;">
            <h4 style="color:#0f8200;"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;&nbsp;${feedback.name}</h4>
            <hr/>
            <p><span class="glyphicon glyphicon-envelope"></span>&nbsp;&nbsp;&nbsp;<b>${feedback.emailId}</b></p>
            <p><span class="glyphicon glyphicon-earphone"></span>&nbsp;&nbsp;&nbsp;<b>${feedback.phoneNumber}</b></p>
            <p><b>Subject:- </b>${feedback.subjectFeedback}</p>
            <hr/>
            <pre>${feedback.feedbackText}</pre>
            <br>
            <hr>
            <form action="${pageContext.request.contextPath}/replyFeedback/${feedback.emailId}/${feedback.subjectFeedback}" method="post">
                <div class="form-group" style="padding-top: 5px;">
                    <textarea class="form-control" name="replyText" rows="2" placeholder="REPLY TEXT" style="text-font:11px;" required></textarea>
                </div>
