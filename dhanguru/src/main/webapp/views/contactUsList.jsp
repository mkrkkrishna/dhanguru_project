		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-9" style="background-color: #d7d7d7;">
					<h4 style="color:#0f8200;">View Enquiry List</h4>
					<hr/>
                    <c:if test="${!empty contactUsList}">
                        <table id="contactUsListTable" class="table table-bordered" style="margin-left: -15px;width:103.5%;">
                            <thead>
                                <tr>
                                    <th style="color:#ffffff;background-color:#0f8200;font-size: 12px;">Name</th>
                                    <th style="color:#ffffff;background-color:#0f8200;font-size: 12px;">Subject</th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${contactUsList}" var="contactUs">
                                    <tr>
                                        <td><a href="${pageContext.request.contextPath}/showContactUsDetails/${contactUs.id}"><h6>${contactUs.name}</h6></a></td>
                                        <td><a href="${pageContext.request.contextPath}/showContactUsDetails/${contactUs.id}"><h6>${contactUs.subjectEnquiry}</h6></a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
