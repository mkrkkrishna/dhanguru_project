	...
	<head>
        ...
        <script>
            $(document).ready(function() {
                $('#fixedInvesterListTable').DataTable();
            } );
		...
		<div class="container-fluid">
			<div class="row">
			            		...
			            		<fieldset>
                                    <div style="border:1px solid #989898;position: relative;left:0%;padding:0em;width:100%;float:left;margin-left:5px;">
        			    		        ...
        			    		        <table cellspacing="4" cellpadding="0" width="100%" style="margin-top:20px;margin-left:15%;">
                                            ...
                                            <tr title="Click to view author detail">
                                                <td style="padding-top:3px;padding-bottom:3px;">
                                                    <a href="${pageContext.request.contextPath}/admin/intrestInInvest">
                                            ...
                                            <tr  title="Click to view author detail">
                                                <td style="padding-top:3px;padding-bottom:3px;">
                                                    <a href="${pageContext.request.contextPath}/admin/adminApprovedInvestment">
                                                        Approved Investment
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr title="Click to view author detail">
                                                <td style="padding-top:3px;padding-bottom:3px;">
                                                    <a href="${pageContext.request.contextPath}/admin/serviceCity">
                                                        Service City
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr title="Click to view author detail">
                                                <td style="padding-top:3px;padding-bottom:3px;">
                                                    <a href="${pageContext.request.contextPath}/admin/enterLoanId">
                                                        Get Security Key
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr title="Click to view author detail">
                                                <td style="padding-top:3px;padding-bottom:3px;">
                                                    <a href="${pageContext.request.contextPath}/admin/fixInvester">
                                                        Fix Invester
                                                    </a>
                                                </td>
                                            </tr>
				...
				<div class="col-sm-9" style="background-color: #d7d7d7;padding-bottom: 20px;">
					<p><h3 style="color:#0f8200;">View Investers List</h3></p><%--<h5 style="margin-right:10px;margin-top:-30px;float: right;"><a href="${pageContext.request.contextPath}/admin/fixInvester" style="color:red;">Fix Invester</a></h5>--%>
					<hr/>

                    <div style="width:100%;margin-top:50px;">
                        <form action="${pageContext.request.contextPath}/admin/getData_AddPayment"  method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Enter Loan ID:</label>
                                <div class="col-md-5">
                    ...
                    <div class="container" style="width: 95%;">
                        <div class="row">
                            <div class="col-sm-6">
                                <p>Loan Id:- <span style="font-size:17px;">${applyForLoan.loanId}</span></p>
                            </div>
                            <div class="col-sm-6">
                                <p>Email Id:- <span style="font-size:17px;">${applyForLoan.emailId}</span></p>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-6">
                                <p>Contact Number:- <span style="font-size:17px;">${applyForLoan.contactDetailsProof}</span></p>
                            </div>
                            <div class="col-sm-6">
                                <p>Loaning Amount:- <span style="font-size:17px;">${applyForLoan.loaningAmount}</span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <c:if test="${!empty fixedInvesterList}">
                        <table id="fixedInvesterListTable" class="table table-bordered" style="width: 103.5%;margin-left:-15px;">
                            <thead>
                                <tr>
                                    <th style="background-color: #0f8200;color:#ffffff;">invester ID</th>
                                    <th style="background-color: #0f8200;color:#ffffff;">Invester Name</th>
                                    <th style="background-color: #0f8200;color:#ffffff;">Invester Email</th>
                                    <th style="background-color: #0f8200;color:#ffffff;">Investing Amount</th>
                                    <th style="background-color: #0f8200;color:#ffffff;">Add Payment</th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${fixedInvesterList}" var="fixedInvester">
                                    <tr>
                                        ...
                                        <td style="text-align:center;"><a href="${pageContext.request.contextPath}/admin/makePayment/${fixedInvester.investerId}/${fixedInvester.loanId}" class="btn btn-info">ADD</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
    	        ...
    	        <div class="row">
        			...
        			<div class="col-md-3">   	        		
                    	...
                    	<div style="text-align:center;box-shadow: 0px 0px 15px white;height:300px;width:100%;">
                    		<ul style="padding:0 0 0 0;margin-left:0px;list-style-type: none;">
