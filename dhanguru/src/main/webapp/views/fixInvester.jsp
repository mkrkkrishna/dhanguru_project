...
<head>
    ...
    <script>
        $(document).ready(function() {
            $('#intrestInInvestListTable').DataTable();
        } );
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3">
            ...
            <p style="margin-left:20%;text-transform: uppercase;font-size:18px;">ADMIN</p>
            </p>
                        ...
                        <fieldset>
                            <div style="border:1px solid #989898;position: relative;left:0%;padding:0em;width:100%;float:left;margin-left:5px;">
                                ...
                                <table cellspacing="4" cellpadding="0" width="100%" style="margin-top:20px;margin-left:15%;">
                                    ...
                                    <tr title="Click to view author detail">
                                    ...
                                    <tr title="Click to view author detail">
                                        <td style="padding-top:3px;padding-bottom:3px;">
                                            <a href="${pageContext.request.contextPath}/admin/intrestInInvest" style="font-color:#FFFFFF;">
                                                Intrest In investment
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr  title="Click to view author detail">
                                        <td style="padding-top:3px;padding-bottom:3px;">
                                            <a href="${pageContext.request.contextPath}/admin/adminApprovedInvestment" style="font-color:#FFFFFF;">
                                                Approved Investment
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr title="Click to view author detail">
                                        <td style="padding-top:3px;padding-bottom:3px;">
                                            <a href="${pageContext.request.contextPath}/admin/serviceCity" style="font-color:#FFFFFF;">
                                                Service City
                                            </a>
                                        </td>
                                    </tr>
                                    <tr title="Click to view author detail">
                                        <td style="padding-top:3px;padding-bottom:3px;">
                                            <a href="${pageContext.request.contextPath}/admin/enterLoanId" style="font-color:#FFFFFF;">
                                                Get Security Key
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr title="Click to view author detail">
                                        <td style="padding-top:3px;padding-bottom:3px;">
                                            <a href="${pageContext.request.contextPath}/admin/fixInvester" style="font-color:#FFFFFF;">
                                                Fix Invester
                                            </a>
                                        </td>
                                    </tr>
        ...
        <div class="col-sm-9" style="background-color: #d7d7d7;padding-bottom: 20px;">
            <%--<h3 style="color:#0f8200;"></h3>--%>

            <div class="container" style="width: 95%;">


                <div class="container">
                    <h3 style="color:#0f8200;">Generate Invester ID</h3>
                    <form action="${pageContext.request.contextPath}/admin/generateInvesterId/${intrestInInvest.id}" class="form-horizontal">
                        <div class="form-group">
                            <label class="control-label col-sm-2">Invester ID:</label>
                            <div class="col-sm-5">
                                <input type="text" style="background-color: #ffffff;" class="form-control" value="${investerId}" id="investerId" placeholder="Generated Invester ID" readonly required>
                ...
                <div class="row">
                    <h3 style="color:#0f8200;">Fix Invester</h3>


                    <div style="width:100%;margin-top:50px;">
                        <form action="${pageContext.request.contextPath}/admin/saveFixInvester"  method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Loan Id:</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="loanId" value="${intrestInInvest.loanId}" readonly>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;font-size:13px;">Invester Name:</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" value="${usersProfile.fullName}" name="investerName" readonly>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Invester Email:</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="investerEmail" value="${intrestInInvest.investorEmail}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Invester Contact:</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" value="${usersProfile.mobile}" name="investerContact" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Investing Amount:</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="investingAmount" value="${intrestInInvest.investingAmount}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2" style="padding-left:30px;">Invester ID:</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" value="${investerId}" name="investerId" readonly>
                                </div>
                            </div>

                            <c:if test="${investerId != null}">
                                <div class="form-group">
                                    <label class="col-md-2" style="padding-left:30px;">Intrest Rate:</label>
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" name="intrestRate" required>
                                    </div>
                                </div>
                            </c:if>
