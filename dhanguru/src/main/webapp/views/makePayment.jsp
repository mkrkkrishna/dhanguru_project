...
<head>
    ...
    <script>
        $(document).ready(function() {
            $('#monthlyTransactionTable').DataTable();
        } );
...
<div class="container-fluid">
    <div class="row">
                        ...
                        <fieldset>
                            <div style="border:1px solid #989898;position: relative;left:0%;padding:0em;padding-top:0em;width:100%;float:left;margin-left:5px;">
                                ...
                                <table cellspacing="4" cellpadding="0" width="100%" style="margin-top:20px;margin-left:15%;">
                                    ...
                                    <tr>
                                        <td style="padding-top:3px;padding-bottom:3px;">
                                            <a href="${pageContext.request.contextPath}/admin/getSecurityKey">
                                                Security Key
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr >
                                        <td style="padding-top:3px;padding-bottom:3px;">
                                            <a href="${pageContext.request.contextPath}/admin/addPayment">
                                                Add Payment
                                            </a>
                                        </td>
                                    </tr>
        ...
        <div class="col-sm-9" style="background-color: #d7d7d7;padding-bottom: 20px;">
            <h3 style="color:#0f8200;">Make Payment</h3>
            <hr/>
            <div style="width:100%;margin-top:50px;">
                <form action="${pageContext.request.contextPath}/admin/savePayment"  method="post" class="form-horizontal" role="form" >
                    <style>
                        .control
                        {
                            height:34px;
                        ...
                        .control[disabled],.form-control[readonly],fieldset[disabled] .form-control{background-color:#eee;opacity:1}

                        .control[disabled],fieldset[disabled] .form-control{cursor:not-allowed}
                    ...
                    <div class="form-group">
                        <label class="col-md-2" style="padding-left:30px;">Select Date:</label>
                        <div class="col-md-5">
                            <select class="control" name="day" required>
                            ...
                            <input class="control" type="month" style="width:79%;" name="yearMonth">

                            <input class="control" type="hidden" value="${loanId}" name="loanId">
                            <input class="control" type="hidden" value="${investerId}" name="investerId">
                            <input class="control" type="hidden" value="${intrestRate}" name="intrestRate">
                            <input class="control" type="hidden" value="${investingAmount}" name="investingAmount">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-md-2" style="padding-left:30px;font-size:13px;">Capital Payment:</label>
                        <div class="col-md-5">
                            <input type="number" class="form-control" name="capitalPaid" placeholder="Enter Capital Paid" required>
                        </div>
                    </div>
            ...
            <c:if test="${!empty savePaymentList}">
                <table id="monthlyTransactionTable" class="table table-bordered" style="width: 103.5%;margin-left:-15px;">
                    <thead>
                       <tr>
                           <th style="background-color: #0f8200;color:#ffffff;">Day</th>
                           <th style="background-color: #0f8200;color:#ffffff;">Month / Year</th>
                           <th style="background-color: #0f8200;color:#ffffff;">Intreast On Capital</th>
                           <th style="background-color: #0f8200;color:#ffffff;">Capital Recieved</th>
                           <th style="background-color: #0f8200;color:#ffffff;">Balance Capital</th>
                       </tr>
                    </thead>
                    <tbody>
                        <c:forEach items="${savePaymentList}" var="savePayment">
                            <tr>
                                <td>${savePayment.day}</td>
                                <td>${savePayment.yearMonth}</td>
                                <td>${savePayment.intrestPaid}</td>
                                <td>${savePayment.capitalPaid}</td>
                                <td>${savePayment.balanceAmount}</td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
