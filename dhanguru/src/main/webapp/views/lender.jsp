	...
	<section style="box-shadow: 0px 0px 5px #006600;">
			...
			<div id="lend_one">
				<div style="background-color:#0f8200;padding:3px;">
					<h3 style="margin-left:15px;color:#FFFFFF;">LENDERS</h3>
				</div>
				<div style="margin:10px 30px 30px 30px;">
					<h4 style="color:#0f8200;">What are the benefits of Lending on DHANGURU ?</h4>
					<p>
						Boost your savings by lending on unused liquidity / money to real people through DHANGURU and earn returns up to 5% per month*. You can now lend as low as Rs.20,000. The rate of interest offered at DHANGURU is way higher than offered by any Bank or Financial Institutions.
					</p>
				
					<h4 style="color:#0f8200;">Get high returns on idle / unused cash</h4>
					<p>
						You can earn heavy returns on your unused liquidity by lending the same to the real people through DHANGURU.
					</p>
				
					<h4 style="color:#0f8200;">Earn monthly without doing Anything.</h4>
					<p>
						Get repaid every month through EMIs.
					</p>
				
					<h4 style="color:#0f8200;">Credit Worthy Borrowers</h4>
					<p>
						Strict verification mechanism ensures only credit worthy borrowers to be listed.
					</p>
				
					<h4 style="color:#0f8200;">Lend to multiple borrowers at the same time</h4>
					<p>
						Diversify your unused / idle cash and liquidity by lending in multiple borrowers and secure your money through the items given towards security by the borrowers.
					</p>
				</div>
			</div>
			<div id="lend_two" style="margin:30px;">
				<h3 style="color:#0f8200;">Responsible Lending </h3>
				<p>
			...
			<div id="lend_one" style="margin:30px;">
				<h3 style="color:#0f8200;">How to Lend ?</h3>
