...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9" style="background-color:#d7d7d7;padding-bottom: 20px;">
            <h3 style="color:#0f8200;">Enter Security Key</h3>
            <hr/>

            <div style="width:100%;margin-top:50px;">
                <form action="${pageContext.request.contextPath}/checkSecurityKey/${id}"  method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="col-md-2" style="padding-left:30px;">Security Key:</label>
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="securityKey" placeholder="Enter Security Key" required>
                        </div>
                    </div>
