    ...
    <style>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-3">
					...
					<table class="table" cellpadding="0" cellspacing="0">
    					<tr>
        					<td>
			            		<fieldset>
                                    <div style="border:1px solid #989898;position: relative;left:0;;width:100%;float:left;margin-left:5px;">
				...
				<div class="col-sm-8" style="background-color: #d7d7d7;padding-bottom: 20px;">
					<h4 style="color:#0f8200;">Who Apply For Loan List</h4>
					<hr/>
                    <c:if test="${!empty applyForLoanList}">
                        ...
                        <table id="applyForLoanListTable" class="table table-bordered" style="margin-left:-15px;width: 103.5%;">
                            <thead>
                            <tr>
                                <th style="color:#ffffff;background-color:#0f8200;font-size:12px;">Loan Id</th>
                                <th style="color:#ffffff;background-color:#0f8200;font-size:12px;">Email</th>
                                <th style="color:#ffffff;background-color:#0f8200;font-size:12px;">Contact</th>
                                ...
                                <th style="color:#ffffff;background-color:#0f8200;font-size:12px;">Investers</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${applyForLoanList}" var="applyForLoan">
                                <tr>
                                    <td><h6>${applyForLoan.loanId}</h6></td>
                                    <td><h6>${applyForLoan.emailId}</h6></td>
                                    <td><h6>${applyForLoan.contactDetailsProof}</h6></td>
                                    <td><h6>${applyForLoan.loaningAmount}</h6></td>
                                    <td><a href="${pageContext.request.contextPath}/checkSecurityKey/${applyForLoan.id}"><h6>More Details</h6></a></td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/admin/intrestInInvest/${applyForLoan.loanId}"><h6>Investers</h6></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
